...
<picture >
  <source type="image/webp" srcset="img/founder.jpg.webp">
  <source type="image/jpeg" srcset="img/founder.jpg.jpg">
  <img class="founder-photo" src="img/founder.jpg.jpg" alt="founder">
</picture>
  <div class="container">
    <div class="founder-content-wrapper">
      <div class="founder-content">
        ...
        <a href="about.php" class="founder-link">Подробнее о компании</a>
        <a href="#" class=" founder-link2">О нашей миссии</a>
        <!-- /.founder-text -->
      </div>
      <!-- /.founder-content -->
    </div>
